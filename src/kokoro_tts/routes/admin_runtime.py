...
def config_snapshot(cfg) -> dict:
    data = {
        ...
        "moss_stream_prebuffer_seconds": getattr(cfg, "moss_stream_prebuffer_seconds", 0.45),
        "moss_max_silence_ms": getattr(cfg, "moss_max_silence_ms", 850),
        "moss_crossfade_ms": getattr(cfg, "moss_crossfade_ms", 25),
        "moss_segment_pause_ms": getattr(cfg, "moss_segment_pause_ms", 100),
        "moss_runtime_pause_max_ms": getattr(cfg, "moss_runtime_pause_max_ms", 500),
        "moss_output_target_peak": getattr(cfg, "moss_output_target_peak", 0.78),
        "moss_output_gain": getattr(cfg, "moss_output_gain", 0.88),
        ...
        "moss_low_vram_segment_length": getattr(cfg, "moss_low_vram_segment_length", 160),
