...
_field(
    ...
    10,
    rebuild_moss=True,
    help="NAS/P4 默认 180；12GB+ 可在长文本旁白预设中提高到 260-300。",
)
_field(
...
ADMIN_CONFIG_PROFILES: dict[str, dict[str, Any]] = {
    "nas_stable": {
        "label": "NAS 稳定",
        "description": "默认推荐：8GB/P4/家用 NAS，优先不爆显存。",
        "values": {
    ...
    "low_latency": {
        ...
        "values": {
            ...
            "moss_stream_prebuffer_seconds": 0.30,
            "moss_crossfade_ms": 18,
            "moss_realtime_streaming_decode": True,
        },
    },
    "clone_quality": {
