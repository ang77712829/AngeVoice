...
python - <<'PY'
import kokoro_tts
assert kokoro_tts.__version__ == '2.6.0'
...
git checkout main
git pull
git tag -a v2.6.0 -m "AngeVoice v2.6.0"
...
```text
ghcr.io/ang77712829/angevoice-cpu:v2.6.0
ghcr.io/ang77712829/angevoice-gpu:v2.6.0
ghcr.io/ang77712829/angevoice-legacy-gpu:v2.6.0
```
